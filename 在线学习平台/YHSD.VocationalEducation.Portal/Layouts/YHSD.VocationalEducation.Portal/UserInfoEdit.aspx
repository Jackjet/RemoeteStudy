...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfoEdit.aspx.cs" Inherits="YHSD.VocationalEducation.Portal.Layouts.YHSD.VocationalEducation.Portal.UserInfoEdit"  %>
            ...
            $('#ddlCompany').combotree({
                ...
                onSelect: function (node) {
                  ...
                  onLoadSuccess: function () {
                      var deptid = document.getElementById("<%=this.HidDeptID.ClientID %>").value;
...
<%--            $('#ddljiaose').combotree({
	         onSelect: function (node) {
                ...
                onLoadSuccess: function () {
                    var Postionid = document.getElementById("<%=this.HidPostionID.ClientID %>").value;
 	             if (Postionid != null && Postionid != "") {
 	                 $('#ddljiaose').combotree("setValue", Postionid);
 	             }
...
<form id="Form" runat="server">
    ...
    <table class="tableEdit MendEdit" style="width:100%;">
        ...
        <tr>
            ...
            <th>性别</th>
            <td><div style="width:200px;"><asp:RadioButton ID="radMale" runat="server" GroupName="Sex" Text="男" Checked="true"/><asp:RadioButton 
...
onclick="WdatePicker({ isShowClear: true, readOnly: true });"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td><div id="divCompany"><select id="ddlCompany" class="easyui-combotree" style="width:200px;height:29px;"
        ></select></div></td>
            <th>角色</th>
            <td><%--<select id="ddljiaose" class="easyui-combotree" style="width:200px;height:29px;"
        data-options="url:'PositionTree.aspx',required:false"></select>--%>
                <asp:TextBox ID="PostionName" runat="server" ReadOnly="True"  class="inputpart" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>手机</th>
                         ...
                         <script type="text/javascript" language="javascript">
                             $(function () {
                                 ...
                                 $("#uploadify").uploadify({
                                     ...
                                     'uploader': 'UserInfoEdit.aspx',            //上传处理页面,可以aspx
                                     'formData': { HDUserImg: $("#HidEditImg").val() }, //参数
                                     //'fileTypeDesc': '',
