...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DeleteChapter(id) {
            // LayerAlert('不能删除角色!!');
            LayerConfirmDelete("确定删除此章节吗?", function () {
...
<table class="list_table" cellspacing="0" cellpadding="0" border="0">
        <tr class="tab_th top_th">
            ...
            <ItemTemplate>
              ...
              <td class="td_tit"><a title="编辑章节" href="<%=YHSD.VocationalEducation.Portal.Code.Common.CommonUtil.GetChildWebUrl()%>/_layouts/15/YHSD.VocationalEducation.Portal/ChapterEdit.aspx?id=<%#Eval("Id")%>" target="_self"><img  class="EditImg" /></a><a title="删除章节" onclick="DeleteChapter('<%#Eval("Id") %>')"><img class="DelImg"  /></a></td>
                    </tr>
                </ItemTemplate>
    ...
    <div id="containerdiv" style="overflow: hidden; display: inline-block;">
     ...
     <div class="main_button_part">
          <asp:Button ID="BTAdd" runat="server" Text="添加章节" CssClass="button_s"   OnClientClick="return CreaterChapter()"/>
         </div>
</asp:Content>
