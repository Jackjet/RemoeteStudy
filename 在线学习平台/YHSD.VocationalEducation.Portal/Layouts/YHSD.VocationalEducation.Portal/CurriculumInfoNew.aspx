...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
     ...
     <asp:HiddenField ID="HDID" runat="server" />
        <table class="tableEdit">
            ...
            <td><asp:TextBox ID="txtTitle" Width="400px" runat="server" CssClass="inputPart"></asp:TextBox></td>
        </tr>
        <tr>
            <th>课程描述&nbsp;<span style="color:Red">*</span></th>
            <td><asp:TextBox ID="txtDescription" runat="server" Width="400px" Height="80px" TextMode="MultiLine" Rows="6"  CssClass="inputPart"></asp:TextBox></td>
        </tr>
             <tr>
...
<%--                     <label class="LabelImg"  id="LabelImgUrl" runat="server" visible="false"></label>
            ...
            <td><asp:RadioButton ID="radYes" runat="server" GroupName="Open" Text="是" /><asp:RadioButton ID="radNo" runat="server" GroupName="Open" Text="否" Checked="true"/>
            </td>
        </tr>
           <tr>
          <th>相关课程&nbsp;</th>
