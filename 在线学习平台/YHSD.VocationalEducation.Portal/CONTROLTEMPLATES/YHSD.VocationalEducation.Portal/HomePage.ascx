...
<div class="f_l">
            	<div class="classes_main">
                    ...
                    <div class="classes_content">
                        ...
                        <div><img src="<%#Eval("ImgUrl") %>"   title="<%#Eval("Description") %>"  onerror='this.src="<%=YHSD.VocationalEducation.Portal.Code.Common.PublicEnum.NoTuPianUrl%>"' width="170" height="108" /></div>
