...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CO_wp_OrderDetailListUserControl.ascx.cs" Inherits="SVDigitalCampus.Canteen_Ordering.CO_wp_OrderDetailList.CO_wp_OrderDetailListUserControl" %>
                    ...
                    <div id="slide">
                        ...
                        <ul>
                            ...
                            <asp:ListView ID="lvDateOrder" runat="server" OnPagePropertiesChanging="lvDateOrder_PagePropertiesChanging">
                                ...
                                <asp:Label ID="OrderNumber" runat="server" Text='<%#Eval("OrderNumber") %>'></asp:Label>|<%#Eval("User") %>|
                                                                    金额：￥<%#Eval("Total") %></h2>
                                                                <asp:ListView ID="lv_OrderMenu" runat="server" ItemPlaceholderID="MenuPlaceHolder">
                                                                    <EmptyDataTemplate>
                                                                        亲，暂无订单菜品记录！
                                                                    </EmptyDataTemplate>
                                                                    <LayoutTemplate>
