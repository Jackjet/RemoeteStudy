...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CO_wp_OrderInfoListUserControl.ascx.cs" Inherits="SVDigitalCampus.Canteen_Ordering.CO_wp_OrderInfoList.CO_wp_OrderInfoListUserControl" %>
                ...
                <ul>
                    <li class="">
                        <div class="qiehuan fl"><span class="qijin">
                            <asp:LinkButton ID="btnToday" runat="server" CssClass="Enable">今日订单</asp:LinkButton><asp:LinkButton ID="btnOld" runat="server" OnClick="btnOld_Click" CssClass="Disable">历史订单</asp:LinkButton></span></div>
                    </li>
                    <%-- <li class="times">
