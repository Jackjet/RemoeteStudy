...
{
    public partial class CO_wp_OrderInfoListOfAdminUserControl : UserControl
    {
        ...
        private void BindData()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "历史订单数据绑定");
            }
        }
        ...
        public void BindListView(ListViewItem lvitem, string type, string Date)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "历史订单绑定订单菜品数据");
            }
        }
    ...
    "</Value></Eq></Where>";
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "历史订单绑定数据获取菜品状态");
            }
            return status;
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "历史订单时间条件查询");
            }
        }
        //分页
        ...
        public void BindDateOrderListView()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "历史订单绑定日期订单统计数据");
            }
        ...
        public void BindMealTypeOrderListView(ListViewItem lvitem, string Date)
        {
            ...
            {
                log.writeLogMessage(ex.Message, "历史订单绑定三餐订单统计数据");
            }
        }
        ...
        public void BindOrderListView(ListViewItem lvitem, string Type, string Date)
        {
            ...
            {
                log.writeLogMessage(ex.Message, "历史订单绑定三餐下的订单统计数据");
            }
        }
