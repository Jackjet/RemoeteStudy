...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CO_wp_OrderListOfUserUserControl.ascx.cs" Inherits="SVDigitalCampus.Canteen_Ordering.CO_wp_OrderListOfUser.CO_wp_OrderListOfUserUserControl" %>
    ...
    <div class="Whole_display_area">
        <div class="Operation_area">
            <div class="left_choice fl">
                <ul>
                    <li class="">
								<div class="qiehuan fl"><span class="qijin"><asp:LinkButton ID="btnToday" OnClick="btnToday_Click" runat="server" CssClass="Disable">今日订单</asp:LinkButton><asp:LinkButton ID="btnOld" runat="server"   CssClass="Enable">历史订单</asp:LinkButton></span></div>
							</li>
            ...
            <div class="times">
                        <span class="times_input">
                            <input type="text" class="time Wdate" readonly="readonly" runat="server" id="txtdatebegin" onclick="WdatePicker()" /><i class="iconfont"></i></span>-
                        <span class="times_input">
                            <input type="text" class="time Wdate" readonly="readonly" runat="server" id="txtdateend" onclick="WdatePicker()" /><i class="iconfont"></i></span>
