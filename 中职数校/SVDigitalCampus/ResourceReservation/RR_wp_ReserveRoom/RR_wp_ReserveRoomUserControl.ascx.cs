...
namespace SVDigitalCampus.ResourceReservation.RR_wp_ReserveRoom
{
    public partial class RR_wp_ReserveRoomUserControl : UserControl
    {
        SPWeb web = SPContext.Current.Web;
        LogCommon com = new LogCommon();
        public RR_wp_ReserveRoom ReserveRoom { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //string para = Request.Form["__EVENTARGUMENT"];
                //if (control.Equals("appoint") && para.Equals("1") && this.Hid_AppointData.Value!="")
                //{
                //    AddData();
                //    BindSed();
                //}
        ...
        private void BindResouce(string resid)
        {
            ...
            {
                com.writeLogMessage(ex.Message, "RR_wp_ReserveRoom.ascx_BindResouce");
            }
        }
        ...
        private void AddData()
        {
            ...
            {
                com.writeLogMessage(ex.Message, "RR_wp_ReserveRoom.ascx_AddData");
            }
        ...
        private void BindSed()
        {
            ...
            {
                com.writeLogMessage(ex.Message, "RR_wp_ReserveRoom.ascx_BindSed");
            }
        }
