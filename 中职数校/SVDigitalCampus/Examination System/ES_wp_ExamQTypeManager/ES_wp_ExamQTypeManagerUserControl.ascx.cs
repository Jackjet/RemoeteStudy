...
namespace SVDigitalCampus.Examination_System.ES_wp_ExamQTypeManager
{
    public partial class ES_wp_ExamQTypeManagerUserControl : UserControl
    {
        ...
        private void BindList()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "ES_wp_ExamQTypeManager_试题类型管理获取绑定数据");
            }
        }
        /// <summary>
        /// 行命令事件
        ...
        private void Delete(string ID)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "ES_wp_ExamQTypeManager_试题类型管理的删除试题类型");
            }
        ...
        protected void lvEQType_ItemInserting(object sender, ListViewInsertEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "ES_wp_ExamQTypeManager_试题类型管理新增试题类型");
            }
        }
        /// <summary>
        /// 取消
        ...
        protected void lvEQType_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "ES_wp_ExamQTypeManager_试题类型管理修改试题类型");
            }
        }
