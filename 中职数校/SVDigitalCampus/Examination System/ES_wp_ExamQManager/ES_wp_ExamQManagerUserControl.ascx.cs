...
{
    public partial class ES_wp_ExamQManagerUserControl : UserControl
    {
        ...
        protected void BindListView()
        {
            try
            {
                //定义列
                DataTable examdb = new DataTable();
                string[] columns = { "Count", "ID", "Title", "Major", "Subject", "Chapter", "Klpoint", "MajorID", "SubjectID", "ChapterID", "PartID", "KlpointID", "QType", "TypeID", "Type", "DifficultyShow", "Difficulty", "Author", "Created", "Status", "qStatus", "jStatus" };
                examdb = CreateDataTableHandler.CreateDataTable(columns);
                XmlHelper.GetXmlFileName = "ExamQList";
