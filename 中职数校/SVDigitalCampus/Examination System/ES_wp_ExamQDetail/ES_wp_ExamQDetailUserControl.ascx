...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ES_wp_ExamQDetailUserControl.ascx.cs" Inherits="SVDigitalCampus.Examination_System.ES_wp_ExamQDetail.ES_wp_ExamQDetailUserControl" %>
