...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ES_wp_EditExamQuestionUserControl.ascx.cs" Inherits="SVDigitalCampus.Examination_System.ES_wp_EditExamQuestion.ES_wp_EditExamQuestionUserControl" %>
...
<form>
    <div class="Question">
        ...
        <div class="t_btn">
            <input id="btnEdit" class="btn" onclick="Edit(this)" type="button" value="保存" />
        </div>
    </div>
</form>
...
<script type="text/javascript">
   ...
   //修改
    function Edit(obj) {
            ...
            var Majortit = $('#<%=Major.ClientID%>').text();
            var Subjecttit = $('#<%=Subject.ClientID%>').find("option:selected").text();
            var Chaptertit = $('#<%=Chapter.ClientID%>').find("option:selected").text();
            var Parttit = $('#<%=Part.ClientID%>').find("option:selected").text();
            var Pointtit = $('#<%=Point.ClientID%>').find("option:selected").text();
            var Typetit = $('#<%=Type.ClientID%>').find("option:selected").text();
