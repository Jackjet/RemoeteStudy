...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ES_wp_ExamListUserControl.ascx.cs" Inherits="SVDigitalCampus.Examination_System.ES_wp_ExamList.ES_wp_ExamListUserControl" %>
                ...
                <ul>
                    <li class="">
                        <div class="qiehuan fl">
                            <span class="qijin">
                                <asp:LinkButton ID="btnMark" runat="server" CssClass="Disable" OnClick="btnMark_Click">待阅试卷</asp:LinkButton>
                                <asp:LinkButton ID="btnExamList" runat="server" CssClass="Enable">已阅试卷</asp:LinkButton></span>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="left_choice fl">
                <ul>
                   ...
                   <%-- <li class="Batch_operation">
                        <asp:DropDownList ID="ddlExam" runat="server" CssClass="option" AutoPostBack="true" OnSelectedIndexChanged="ddlExam_SelectedIndexChanged">
                            <asp:ListItem Text="考试" Value="0"></asp:ListItem>
                        </asp:DropDownList>
                    </li>--%>
                    <li class="times">
        ...
        <div class="Display_form">
            <asp:ListView ID="lvExam" runat="server" OnPagePropertiesChanging="lvExam_PagePropertiesChanging" >
                <EmptyDataTemplate>
                    <table>
                        <tr>
                            <td colspan="7" style="text-align: center">亲，暂无已阅卷考试成绩记录！
                            </td>
                        </tr>
                    </table>
                </EmptyDataTemplate>
