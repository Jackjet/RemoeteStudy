...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ES_wp_ExamPaperOldUserControl.ascx.cs" Inherits="SVDigitalCampus.Examination_System.ES_wp_ExamPaperOld.ES_wp_ExamPaperOldUserControl" %>
    ...
    <div class="Whole_display_area">
         <div class="Operation_area">
            <div class="left_choice fl">
                <ul>
                    <li class="">
						<div class="qiehuan fl"><span class="qijin"><asp:LinkButton ID="btnNever" runat="server"  CssClass="Disable" OnClick="btnNever_Click">未答试卷</asp:LinkButton><a class="Enable">已答试卷</a></span></div>
					</li>
                </ul>
            </div>
            <div class="clear"></div>
            ...
            <asp:ListView ID="lvExam" runat="server" OnPagePropertiesChanging="lvExam_PagePropertiesChanging" >
                <EmptyDataTemplate>
                    <table class="D_form">
                        <tr class="trth">
                            ...
                            <th class="Contact">阅卷状态
                            </th>
                            <th class="Contact">阅卷人
                            </th>
                ...
                <ItemTemplate>
                    <tr class="Single">
                        ...
                        <td class="Author"><%#Eval("Marker")%></td>
                        <td class="Operation">
                            <a href="javascript:void(0);" onclick="Look('<%# Eval("ID") %>','<%#Eval("ExamID")%>');" style="color: blue;" title="分析"><i class="iconfont">&#xe60c;</i></a>
                        </td>
                    </tr>
