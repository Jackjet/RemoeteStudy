...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IF_wp_StudentlistUserControl.ascx.cs" Inherits="SVDigitalCampus.Internship_Feedback.IF_wp_Studentlist.IF_wp_StudentlistUserControl" %>
            ...
            <asp:ListView ID="LV_TermList" runat="server" OnPagePropertiesChanging="LV_TermList_PagePropertiesChanging" OnItemCommand="LV_TermList_ItemCommand" OnItemEditing="LV_TermList_ItemEditing" OnItemDataBound="LV_TermList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="Single">
                        ...
                        <td><%#Eval("ZYMC")%></td>
                        <td>
                            <asp:Label ID="lbIsAssign" runat="server" Text='<%#Eval("FP").ToString()=="0"?"可分配":"已分配"%>'></asp:Label></td>
                        <td>
                            <asp:Label ID="lbIsfeedBack" runat="server" Text='<%#Eval("FK").ToString()=="0"?"未反馈":"已反馈"%>'></asp:Label></td>
                        <%--<td class="Operation">
                            <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Edit" CommandArgument=' <%#Eval("ID")%>'><i class="iconfont">&#xe62f;</i></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Del" CommandArgument=' <%#Eval("ID")%>' OnClientClick="return confirm('确实要删除该企业信息吗？')"><i class="iconfont">&#x3474;</i></asp:LinkButton>
