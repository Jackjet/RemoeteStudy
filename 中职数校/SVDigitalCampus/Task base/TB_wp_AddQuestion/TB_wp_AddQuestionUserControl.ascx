...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TB_wp_AddQuestionUserControl.ascx.cs" Inherits="SVDigitalCampus.Task_base.TB_wp_AddQuestion.TB_wp_AddQuestionUserControl" %>
...
<form>
    <div class="Question">
        ...
        <div class="t_btn">
            <input id="btnAdd" class="btn" onclick="Add()" type="button" value="新增" />
        </div>
    </div>
</form>
