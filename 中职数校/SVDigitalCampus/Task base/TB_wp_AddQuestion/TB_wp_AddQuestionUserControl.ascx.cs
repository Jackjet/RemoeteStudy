...
namespace SVDigitalCampus.Task_base.TB_wp_AddQuestion
{
    public partial class TB_wp_AddQuestionUserControl : UserControl
    {
                ...
                if (ishave)
                {
                    ...
                    foreach (ListItem subitem in Subject.Items)
                    {
                        ...
                        if (subitem.Value.Equals(SubjectID))
                        {
                            ...
                            //绑定章
                            BindMajor(getNodesDb(Convert.ToInt32(SubjectID)), Chapter);
        ...
        public void BindMajor(DataTable majordt, HtmlSelect ddlControl)
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "TB_wp_AddQuestion_绑定专业");
            }
        }
        ...
        private void BindExamQType()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.writeLogMessage(ex.Message, "TB_wp_AddQuestion_绑定试题类型");
            }
        }
