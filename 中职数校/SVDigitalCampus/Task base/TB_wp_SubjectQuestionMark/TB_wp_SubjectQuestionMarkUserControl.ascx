...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TB_wp_SubjectQuestionMarkUserControl.ascx.cs" Inherits="SVDigitalCampus.Task_base.TB_wp_SubjectQuestionMark.TB_wp_SubjectQuestionMarkUserControl" %>
            ...
            <div>
                <table class="S_analysis">
                    <tr>
                        ...
                        <td rowspan="2">科目：<asp:Label ID="Subject" runat="server" Text=""></asp:Label><br />
                            班级：
                                ...
                                <asp:ListView ID="QuestionTypeOne" runat="server">
                                    <ItemTemplate>
                                        <div class="defen fl">
                                            ...
                                            <span class="fenzhi">
                                               <span style='display:<%#Eval("IsShow")%>' ><%#Eval("GetScore") %></span>
                                                <input type="text" id='PGetScore' name='<%#"PGetScore"+Eval("ID") %>' onkeyup="WorkSocre(this)" class="fenzhiinput"  style='display: <%#Eval("kuangIsShow")%>' /></span>
                                        ...
                                        <div class="ticon fl">
                                            ...
                                            <p class="xuanxiang" style='display: <%#Eval("IsShow")%>'>
                                                <span>
                                                    ...
                                                    <span style='display: <%#Eval("IsshowAnswer")%>;' class="rightanswer">正确答案为：<%#Eval("Answer") %></span>
                                                </span>
                                            </p>
