...
{
    public partial class TB_wp_ExamAnalysisUserControl : UserControl
    {
                ...
                Privileges.Elevated((oSite, oWeb, args) =>
                {
                    ...
                    using (new AllowUnsafeUpdates(web))
                    {
                        ...
                        if (examrow != null)
                        {
                            ...
                            query.Query = CAML.Where(CAML.Eq(CAML.FieldRef("ID"), CAML.Value(examrow["ExampaperID"].safeToString())));
                            ...
                            if (listitem != null && listitem.Count > 0)
                            {
                                ...
                                if (item != null)
                                {
                                    ...
                                    MarkAnalysis.Text = examrow["MarkAnalysis"].safeToString() == "" ? "无" : examrow["MarkAnalysis"].safeToString();
                                    //绑定试卷得分
                                    ...
                                    //测试人数、最高分
                                    decimal hightests = 0;
                                    int acount = GetExamAnswer(examrow["ExampaperID"].safeToString(), out hightests);
            ...
            try
            {
                ...
                foreach (DataRow item in subdt.Rows)
                {
                    ...
                    if (aitems != null && aitems.Count > 0)
                    {
                        ...
                        newdr["GetScore"] = aitem["Score"].safeToString().Trim() == "" ? "0" : aitem["Score"].safeToString();
                    }
