...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EO_wp_OrganizationListUserControl.ascx.cs" Inherits="SVDigitalCampus.Executive_Office.EO_wp_OrganizationList.EO_wp_OrganizationListUserControl" %>
<script type="text/javascript">
    ...
    function init1() {
        var getAllNodes = "";
        var getID = "";
        var tree = document.getElementById("tvOrganization").getElementsByTagName("Input");
...
<div class="tableBoxNewDiv">
            <table border="0" class="tableBoxNew" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="newtd">
                        <asp:TreeView ID="tvOrganization" onclick="OnTreeNodeChecked()" runat="server" ShowCheckBoxes="None"
