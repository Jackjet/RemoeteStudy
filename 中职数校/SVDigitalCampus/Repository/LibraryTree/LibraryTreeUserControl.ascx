...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LibraryTreeUserControl.ascx.cs" Inherits="SVDigitalCampus.Repository.LibraryTree.LibraryTreeUserControl" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "get",
            url: FirstUrl + "/_layouts/15/SVDigitalCampus/hander/TreeNodes.aspx?timespan=" + timespan,
            data: { ListName: "资源库" },
            dataType: "text",
