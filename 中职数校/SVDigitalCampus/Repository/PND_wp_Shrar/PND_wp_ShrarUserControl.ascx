...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PND_wp_ShrarUserControl.ascx.cs" Inherits="SVDigitalCampus.Repository.PND_wp_Shrar.PND_wp_ShrarUserControl" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "get",
            url: FirstUrl + "/_layouts/15/SVDigitalCampus/hander/LibraryList.aspx",
            dataType: "text",
