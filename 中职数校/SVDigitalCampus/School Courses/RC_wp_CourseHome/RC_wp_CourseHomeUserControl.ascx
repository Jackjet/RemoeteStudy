...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RC_wp_CourseHomeUserControl.ascx.cs" Inherits="SVDigitalCampus.School_Courses.RC_wp_CourseHome.RC_wp_CourseHomeUserControl" %>
...
<div class="Course_home">
    ...
    <div class="xbkc">
        ...
        <div class="xxk_gonggao fl">
            ...
            <div class="content">
                <div class="xxk_tp">
                    <img src="../../../../_layouts/15/SVDigitalCampus/Image/bg_login.jpg" alt="">
                    <p>新一轮的选修课正式开课了</p>
                </div>
                <ul id="notic">
                </ul>
