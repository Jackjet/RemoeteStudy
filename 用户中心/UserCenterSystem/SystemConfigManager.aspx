<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemConfigManager.aspx.cs" Inherits="UserCenterSystem.SystemConfigManager" %>
    ...
    <script type="text/javascript">
        ...
        function funExcelImportStu(id) {
            wbox = $("#EditButton").wBox({
                ...
                requestType: "iframe",
                title: "编辑",
                target: "SystemConfigMangerAdd.aspx?id=" + id + "&t=" + new Date().getTime()
            });
            wbox.showBox();
        }
        function funaddImportStu( ) {
            wbox = $("#btnaddInfo").wBox({
                ...
                requestType: "iframe",
                title: "编辑",
                target: "SystemConfigMangerAdd.aspx?t=" + new Date().getTime()
            });
            wbox.showBox();
        }
    </script>
    ...
    <form id="form1" runat="server">
        <div class="con_wrap">
            ...
            <div id="contentAll" class="con_list">
                ...
                <asp:ListView ID="lvSystem" runat="server" DataKeyNames="ID" OnPagePropertiesChanging="lvSystem_PagePropertiesChanging" OnItemEditing="lvSystem_ItemEditing" OnItemCommand="lvSystem_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr style="text-align: center">
                            ...
                            <td>
                                <%--<asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="修改" CausesValidation="false" BackColor="Wheat" />--%>
                    ...
                    <LayoutTemplate>
                        <table id="itemPlaceholderContainer" runat="server" border="0" style="width: 100%">
                            <tr runat="server" class="b_txt alt-row">
                                ...
                                <th runat="server" style="width: 100px;">系统名称</th>
                                <th runat="server" style="width: 60px;">管理员</th>
                ...
                <div class="pagination">
                    <div style="margin-left: 355px;">
                        <asp:DataPager ID="DPTeacher" runat="server" PageSize="10" PagedControlID="lvSystem">
                            <Fields>
