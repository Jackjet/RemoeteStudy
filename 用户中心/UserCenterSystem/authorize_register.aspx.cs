...
{
    public partial class authorize_register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(UserType))
            {
                ...
                UserType = "教师";
                //Btnteacher.ImageUrl = "~/images/link.png";
            ...
            if (!IsPostBack)
            {
                Btnteacher.CssClass = "btnflagok";//让教师的样式选中
                XM = "";
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //if (parBll.IsExist(txtSFZ.Text))
                        //{
                        //    CustomIsValid = false;
                        //    lblsfz.Text = "该身份证已被用户注册过了";
                        //    lblsfz.ForeColor = System.Drawing.Color.Red;
                        //    ChenckControls(false);
                        //    return;
                        //}
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (IsValid & CustomIsValid)
                {
                        ...
                        !string.IsNullOrWhiteSpace(IDCard) & !string.IsNullOrWhiteSpace(yzm))
                    {
                        ...
                        {
                            // alert("验证码错误,请更换验证码后重新输入");
                            lblMessage.Text = "验证码输入有误";
            ...
            catch (Exception ex)
            {
                ...
                alert("用户【" + displayName + "】 注册失败,请重新注册");
            }
        }
        protected void alert(string strMessage)
        {
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(UpdatePanel1, this.GetType(), "Button_Click", "alert('" + strMessage + "')", true);
        ...
        protected void alert(string str, string url)
        {
            System.Web.UI.ScriptManager.RegisterStartupScript(UpdatePanel1, this.GetType(), "name", "alert('" + str + "');location.href='" + url + "';", true);
        }
        /// <summary>
        /// 【Button】【教师】
        /// </summary>
        protected void Btnteacher_Click(object sender, EventArgs e)
        {
            ...
            Btnteacher.CssClass = "btnflagok";
            Btnstudent.CssClass = "btnflag";
            //Btnparent.CssClass = "btnflag";
        ...
        protected void Btnstudent_Click(object sender, EventArgs e)
        {
            ...
            Btnstudent.CssClass = "btnflagok";
            Btnteacher.CssClass = "btnflag";
            //Btnparent.CssClass = "btnflag";
