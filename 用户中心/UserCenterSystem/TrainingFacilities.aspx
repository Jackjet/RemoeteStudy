<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingFacilities.aspx.cs" Inherits="UserCenterSystem.TrainingFacilities" %>
        ...
        <div class="con_wrap">
            ...
            <div class="divMain">
                <asp:Panel ID="AddPanel" runat="server">
                    &nbsp;&nbsp;<asp:Button ID="btAdd" runat="server" Text="登记" OnClick="btAdd_Click" BackColor="Wheat" />&nbsp;&nbsp;
                            ...
                            <ItemTemplate>
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        ...
                                        <asp:HiddenField ID="hfNJMC" runat="server" Value='<%#Eval("SBMC") %>' />
                ...
                <asp:Panel ID="panelAdd" runat="server" Visible="false">
                    <div style="width: 440px; margin: 50px auto;">
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    设施名称<span style="color: Red;">*</span>
