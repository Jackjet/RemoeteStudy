...
namespace Common
{
    ...
    public static class ExcelCommon
    {
        ...
        /// <returns></returns>
        private static string GetConnectString(string strExtName)
        {
            try
            {
                if (!File.Exists(strExtName))
                    return string.Empty;
                string strConn;
                if (strExtName.EndsWith("xls", StringComparison.InvariantCultureIgnoreCase))
                {

                    //strConn = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + strExtName + ";Extended Properties=\"Excel 8.0;HDR=No\"";
                    strConn = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + strExtName + ";Extended Properties=Excel 8.0;";
                }
                else if (strExtName.EndsWith("xlsx", StringComparison.InvariantCultureIgnoreCase))
                {
                    //strConn = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + strExtName + ";Extended Properties=\"Excel 12.0 Xml;HDR=No\"";
                    strConn = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + strExtName + ";Extended Properties=\"Excel 12.0 Xml;";
                }
                else
                    return string.Empty;
                return strConn;
            ...
            catch (Exception ex)
            {
                return string.Empty;
                throw ex;
                //LogCommon.writeLogUserCenter(ex.Message, "ExcelCommon");
            }
        }
        ...
        /// Excel 转换成DataTable
        /// </summary>
        /// <param name="p_strFileName">文件完整路径</param>
        /// <returns></returns>
        public static DataTable GetTableFromExcel(string p_strFileName, string sheetName)
        {
            //string connStrTemplate = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties=Excel 8.0;";
            //string connStrTemplate = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties=Excel 12.0 Xml;HDR=No";
            //string connStrTemplate = "Provider=Provider=Microsoft.Jet.OLEDB.4.0;Data Source={0};Extended Properties=Excel 8.0;";
            //connStrTemplate = string.Format(connStrTemplate, p_strFileName);

            try
            {
                string connStrTemplate = GetConnectString(p_strFileName);
                DataTable dt = null;
                ...
                foreach (DataRow dr in schemaTable.Rows)
                {
                   ...
                   // {
                        strSQL = "Select * From [" + dr["TABLE_NAME"].ToString() + "]";
                   // }
                }
        ...
        public static void ExportExcel(System.Data.DataTable dtData, string FileName)
        {
            try
            {
        ...
        /// 导出Excel文件，转换为可读模式
        /// </summary>
        public static void ExportExcelReadOnly(System.Data.DataTable dtData)
        {
        ...
        /// 导出Excel文件，并自定义文件名
        /// </summary>
        public static void ExportExcelByFileName(System.Data.DataTable dtData, String FileName)
        {
            GridView dgExport = null;
            HttpContext curContext = HttpContext.Current;
            StringWriter strWriter = null;
        ...
        public static bool ExportExcelByFilePath(DataTable Table, string ExcelFilePath)
        {
