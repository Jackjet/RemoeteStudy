...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CE_wp_WdScoreUserControl.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.CourseEvaluate.CE_wp_WdScore.CE_wp_WdScoreUserControl" %>
<link href="/_layouts/15/Style/common.css" rel="stylesheet" />
<link href="/_layouts/15/Style/StuAssociate.css" rel="stylesheet" type="text/css" />
<style type="text/css">    
    td{ vertical-align:middle; }
    .title { padding:0 5px;width:390px;height:300px }
</style>
...
<div class="windowDiv">
    <table class="winTable">
        <tr>
            ...
            <td class="ku"><asp:TextBox ID="TB_Title" runat="server" Width="390px" />
        ...
        <tr>
            ...
            <td class="ku"><asp:TextBox ID="TB_Text" TextMode="MultiLine" placeholder="留下你对这门课的认识呗~" CssClass="title" runat="server" />
                <span style="color: red;">*
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TB_Text"
                                ErrorMessage="必填" ValidationGroup="ProjectSubmit" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator></span></td>
        </tr>
    </table>
    <div class="t_btn">
