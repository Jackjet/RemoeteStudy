...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CE_wp_CourseScoreResultUserControl.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.CourseEvaluate.CE_wp_CourseScoreResult.CE_wp_CourseScoreResultUserControl" %>
