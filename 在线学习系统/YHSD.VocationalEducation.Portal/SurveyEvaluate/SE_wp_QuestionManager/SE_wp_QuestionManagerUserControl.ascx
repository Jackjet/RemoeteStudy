...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_QuestionManagerUserControl.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.SurveyEvaluate.SE_wp_QuestionManager.SE_wp_QuestionManagerUserControl" %>
