...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_EditSurveyPaperUserControl.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.SurveyEvaluate.SE_wp_EditSurveyPaper.SE_wp_EditSurveyPaperUserControl" %>
    ...
    <div class="writing_form" style="margin:auto;width:650px">
        ...
        <table class="winTable" style="margin-left:90px">
            ...
            <tr>
                ...
                <td class="ku">
                    <asp:TextBox ID="TB_Title" TextMode="MultiLine" Width="350px" Height="26px" runat="server" />
                <span style="color: red;">*
                            <asp:RequiredFieldValidator ID="RFV_A" runat="server" ControlToValidate="TB_Title"
