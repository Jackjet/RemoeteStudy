...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_SelectQuestionUserControl.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.SurveyEvaluate.SE_wp_SelectQuestion.SE_wp_SelectQuestionUserControl" %>
