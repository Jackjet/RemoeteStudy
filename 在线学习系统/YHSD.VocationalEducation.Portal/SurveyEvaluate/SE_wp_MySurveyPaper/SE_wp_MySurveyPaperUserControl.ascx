...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_MySurveyPaperUserControl.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.SurveyEvaluate.SE_wp_MySurveyPaper.SE_wp_MySurveyPaperUserControl" %>
            ...
            <asp:ListView ID="lvSurveyPaper" runat="server">
                ...
                <ItemTemplate>
                    <tr class="Single">
                        ...
                        <td>
                            <a href="UseSurveyPaperP.aspx?itemid=<%#Eval("ID")%>" class="btnpass">开始评价</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
