...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div style="display:none">
        <asp:Button runat="server" ClientIDMode="Static" ID="SendMsg" OnClick="SendMsg_Click" />
    </div>
