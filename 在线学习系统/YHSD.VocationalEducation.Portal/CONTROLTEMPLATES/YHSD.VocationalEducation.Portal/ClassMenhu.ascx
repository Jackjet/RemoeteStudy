...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClassMenhu.ascx.cs" Inherits="YHSD.VocationalEducation.Portal.CONTROLTEMPLATES.YHSD.VocationalEducation.Portal.ClassMenhu" %>
<style>
    .kaiKeDate {
        font-size: 12px;
        font-family: "微软雅黑","宋体";
    ...
    .banjiimg{  border: 2px solid #ddd;
    box-shadow: 1px 1px 1px #bbb;
    height: 300px;
    width: 800px; margin:10px;}
    .clear{ clear:both;}
</style>
<script>
...
<div class="student_main">
    <div class="banjiclass">
                <img src="/_layouts/15/YHSD.VocationalEducation.Portal/images/banji1.jpg" class="banjiimg" />
                <%--<asp:Image ID="Img_BanjiImg" runat="server" />--%></div>
    <div class="clear"></div>
    <div class="f_l">
    ...
    <div class="right_part f_r">
        <div class="class_library" style="display:none;">
