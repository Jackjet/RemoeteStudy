<%@ Page Title="" Language="C#" MasterPageFile="~/Moblie.Master" AutoEventWireup="true" CodeBehind="ZuoYe.aspx.cs" Inherits="Moblie.CountPage.ZuoYe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DrawChart(divId, flashFileName, width, height) {
            ...
            myChart.setDataXML('<chart caption="作业批改" numberPrefix=""><set value="25" label="9月" color="AFD8F8" /><set value="17" label="10月" color="F6BD0F" /><set value="23" label="11月" color="8BBA00" isSliced="1" /></chart>');
