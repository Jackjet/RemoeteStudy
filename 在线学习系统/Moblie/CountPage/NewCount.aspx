<%@ Page Title="" Language="C#" MasterPageFile="~/Moblie.Master" AutoEventWireup="true" CodeBehind="NewCount.aspx.cs" Inherits="Moblie.CountPage.NewCount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DrawChart(divId, flashFileName, width, height) {
            ...
            myChart.setDataXML('<chart caption="新闻统计" numberPrefix=""><set value="25" label="9月访问次数" color="AFD8F8" /><set value="17" label="10月访问次数" color="F6BD0F" /><set value="23" label="11月访问次数" color="8BBA00" isSliced="1" /></chart>');
