<%@ Page Title="" Language="C#" MasterPageFile="~/Moblie.Master" AutoEventWireup="true" CodeBehind="ExamMgr.aspx.cs" Inherits="Moblie.ExamMgr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <script type="text/javascript">
        function StartTest(obj) {
            ...
            var layerIndex = OL_ShowLayer(2, "考试", 860, 660, "", function (flag) {
            if (flag)
                ShowData(1);
        });
    ...
    function ShowData(index) {
        ...
        AjaxRequest("~/_layouts/15/YHSD.VocationalEducation.Portal/Handler/PapersMgrHandler.aspx", postData, function (returnVal) {
