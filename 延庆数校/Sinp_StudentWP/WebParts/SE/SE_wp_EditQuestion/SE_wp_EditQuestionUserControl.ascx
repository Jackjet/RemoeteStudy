...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_EditQuestionUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SE.SE_wp_EditQuestion.SE_wp_EditQuestionUserControl" %>
...
<div class="windowDiv">
    <table class="winTable">
        <tr>
            <td class="wordsinfo">组别：</td>
            <td class="ku"><asp:DropDownList ID="DDL_Group" runat="server" Width="100px" CssClass="droplist" /></td>
        ...
        <tr>
            ...
            <td class="ku" colspan="3"><asp:TextBox ID="TB_Title" TextMode="MultiLine" CssClass="title" runat="server" /></td>
        </tr>
        <tr runat="server" id="a">
            <td class="wordsinfo">选项A：</td>
            <td class="ku" colspan="3"><asp:TextBox ID="TB_A" runat="server" Width="300px" />（<asp:TextBox ID="SC_A" runat="server" Width="7px" />分）
        ...
        <tr  runat="server" id="b">
            ...
            <td class="ku" colspan="3"><asp:TextBox ID="TB_B" runat="server" Width="300px" />（<asp:TextBox ID="SC_B" runat="server" Width="7px" />分）
                <span style="color: red;">*
        ...
        <tr  runat="server" id="c">
            ...
            <td class="ku" colspan="3"><asp:TextBox ID="TB_C" runat="server" Width="300px" />（<asp:TextBox ID="SC_C" runat="server" Width="7px" />分）
                <span style="color: red;">*
        ...
        <tr  runat="server" id="d">
            ...
            <td class="ku" colspan="3"><asp:TextBox ID="TB_D" runat="server" Width="300px" />（<asp:TextBox ID="SC_D" runat="server" Width="7px" />分）
                <span style="color: red;">*
