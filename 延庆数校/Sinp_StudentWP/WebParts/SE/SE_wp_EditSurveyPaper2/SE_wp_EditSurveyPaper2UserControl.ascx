...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_EditSurveyPaper2UserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SE.SE_wp_EditSurveyPaper2.SE_wp_EditSurveyPaper2UserControl" %>
...
.btn_cancel{background:#fafafa;border:1px solid #d5d5d5;}
.btn_cancel:hover{background:#e7e7e7;outline:none;}
</style>
