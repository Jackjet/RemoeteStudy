...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SE_wp_SurveyPaperUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SE.SE_wp_SurveyPaper.SE_wp_SurveyPaperUserControl" %>
