...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Master_wp_UserInfoUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.Master.Master_wp_UserInfo.Master_wp_UserInfoUserControl" %>
<style type="text/css">
    .col{
        color:#00a1ec;
    }
