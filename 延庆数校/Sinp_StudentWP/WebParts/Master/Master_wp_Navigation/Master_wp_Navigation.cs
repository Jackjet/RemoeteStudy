...
namespace Sinp_StudentWP.WebParts.Master.Master_wp_Navigation
{
    ...
    public class Master_wp_Navigation : WebPart
    {
        ...
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/Sinp_StudentWP.WebParts.Master/Master_wp_Navigation/Master_wp_NavigationUserControl.ascx";
        ...
        private string _serverUrl = "http://192.168.1.81/sites/DigitalCampus";
