...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TA_wp_ExamAssociaeAuditingUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.TA.TA_wp_ExamAssociaeAuditing.TA_wp_ExamAssociaeAuditingUserControl" %>
...
<div class="windowDiv">
    <table class="winTable">
        ...
        <tr>
            ...
            <td class="ku"><asp:Label runat="server" ID="lbUser"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="wordsinfo">社团介绍：</td>
            <td class="ku" colspan="2"><asp:Label runat="server" ID="lbContent"></asp:Label></td>
        </tr>
        <tr>
