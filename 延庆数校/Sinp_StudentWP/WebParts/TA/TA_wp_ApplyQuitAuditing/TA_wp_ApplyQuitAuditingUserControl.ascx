...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TA_wp_ApplyQuitAuditingUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.TA.TA_wp_ApplyQuitAuditing.TA_wp_ApplyQuitAuditingUserControl" %>
