...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TA_wp_AssociaeHomePicUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.TA.TA_wp_AssociaeHomePic.TA_wp_AssociaeHomePicUserControl" %>
