...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TA_wp_ApplyQuitUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.TA.TA_wp_ApplyQuit.TA_wp_ApplyQuitUserControl" %>
...
<div class="rflf" style="width: 100%">
    <div class="st_nav" style="width: 100%">
        <ul style="width: 100%">
            <li id="one1" class="active"><a href="javascript:void(0)" class="first">入团申请</a></li>
            <li id="one2" ><a href="javascript:void(0)" class="second">退团申请</a></li>
        </ul>
    </div>
                                ...
                                <asp:ListView ID="TempListView" runat="server" OnPagePropertiesChanging="TempListView_PagePropertiesChanging">
                                    ...
                                    <ItemTemplate>
                                        <tr class="Single">
                                            ...
                                            <td><%#Eval("Created")%></td>
                                            <td>
                                                <a href="javascript:void(0)" class="btnpass" onclick="openPage('审核通过','/SitePages/ApplyQuitAuditing.aspx?itemid=<%#Eval("ID")%>&status=审核通过','500','420');return false">通过</a>
                                                <a href="javascript:void(0)" class="btnrefuse" onclick="openPage('审核不通过','/SitePages/ApplyQuitAuditing.aspx?itemid=<%#Eval("ID")%>&status=审核拒绝','500','420');return false">拒绝</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
