...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TA_wp_AddAlbumUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.TA.TA_wp_AddAlbum.TA_wp_AddAlbumUserControl" %>
