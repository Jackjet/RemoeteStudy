...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SA_wp_UploadDepartPhotoUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SA.SA_wp_UploadDepartPhoto.SA_wp_UploadDepartPhotoUserControl" %>
