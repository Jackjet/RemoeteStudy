...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SA_wp_AddDepartmentAlbumUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SA.SA_wp_AddDepartmentAlbum.SA_wp_AddDepartmentAlbumUserControl" %>
