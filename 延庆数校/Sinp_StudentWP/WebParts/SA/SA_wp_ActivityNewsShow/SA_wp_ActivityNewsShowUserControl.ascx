...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SA_wp_ActivityNewsShowUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SA.SA_wp_ActivityNewsShow.SA_wp_ActivityNewsShowUserControl" %>
...
<ul>
        <li style="line-height:28px;">
            <div class="music_news" style="width:90%;margin:auto;margin-top:25px;">
                <asp:Image runat="server" CssClass="img_news" ID="Img_News" ImageUrl="/_layouts/15/Stu_images/zs28.jpg"/>
                <div class="music_nr">
                    <h2>
                    ...
                    <div>
                        ...
                        <span><i class="iconfont">&#xe60b;</i><asp:Literal ID="Lit_ClickCount" runat="server" Text="--" /></span>
                    </div>
                    ...
                    <div class='l_msg'>
                        <div class="firstcon">
                            ...
                            <div class="co_con">
                                ...
                                <span class="Praise">
                                    <asp:LinkButton ID="LB_Zan" runat="server" CommandName="Zan" CommandArgument='<%# Eval("ID") %>'><img src="/_layouts/15/TeacherImages/zan.png" width="18" /><i class="con_num"><%#Eval("GoodCount") %></i></asp:LinkButton>
                                    </span>|
