...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SA_wp_ActivityApplyUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.SA.SA_wp_ActivityApply.SA_wp_ActivityApplyUserControl" %>
                                ...
                                <asp:ListView ID="LV_WaitActivity" runat="server" OnPagePropertiesChanging="LV_WaitActivity_PagePropertiesChanging">
                                    ...
                                    <ItemTemplate>
                                        <tr class="Single">
                                            ...
                                            <td><%#Eval("EndDate")%></td>      
                                            <td>
                                                <a href="javascript:void(0)" class="btnpass" onclick="openPage('审核通过','/SitePages/ActivityApplyAuditing.aspx?itemid=<%#Eval("ID")%>&status=审核通过','700','660');return false">通过</a>
                                                <a href="javascript:void(0)" class="btnrefuse" onclick="openPage('审核不通过','/SitePages/ActivityApplyAuditing.aspx?itemid=<%#Eval("ID")%>&status=审核拒绝','700','660');return false">拒绝</a>
                                            </td>                                      
                                        </tr>
                                    </ItemTemplate>
