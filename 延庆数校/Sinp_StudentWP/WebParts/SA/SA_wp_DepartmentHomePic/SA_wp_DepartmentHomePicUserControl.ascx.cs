...
namespace Sinp_StudentWP.WebParts.SA.SA_wp_DepartmentHomePic
{
    public partial class SA_wp_DepartmentHomePicUserControl : UserControl
    {
        ...
        private void BindHomePic(string itemId)
        {
            ...
            {
                com.writeLogMessage(ex.Message, "SA_wp_DepartmentHomePic_BindHomePic");
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                com.writeLogMessage(ex.Message, "SA_wp_DepartmentHomePic_btnAdd_Click");
            }
