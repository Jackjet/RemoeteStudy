...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CE_wp_CourseScoreUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.CE.CE_wp_CourseScore.CE_wp_CourseScoreUserControl" %>
            ...
            <asp:ListView ID="lvCourseLearned" runat="server">
                ...
                <ItemTemplate>
                    <tr class="Single">
                        ...
                        <td>
                            <a href="javascript:void(0)" class="btnpass" onclick="openPage('评分','/SitePages/WdScore.aspx?itemid=<%#Eval("ID")%>','550','360');return false">我来评分</a>
