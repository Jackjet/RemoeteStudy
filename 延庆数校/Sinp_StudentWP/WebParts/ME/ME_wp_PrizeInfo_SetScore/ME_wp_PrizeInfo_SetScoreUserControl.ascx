...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ME_wp_PrizeInfo_SetScoreUserControl.ascx.cs" Inherits="Sinp_StudentWP.WebParts.ME.ME_wp_PrizeInfo_SetScore.ME_wp_PrizeInfo_SetScoreUserControl" %>
...
<style type="text/css">
    ...
    .setting {float:left;width:183px;height:40px;border:1px solid #0da6ec;margin:2px;list-style:none;line-height:40px}
</style>
<div style="margin:8px;">
    <div style="width: 563px; height: 24px;line-height:30px; margin: 5px auto">
        <span style="float: left">
            <asp:DropDownList CssClass="option" ID="DDL_Level" runat="server" />
            <asp:DropDownList CssClass="option" ID="DDL_Grade" runat="server" />
            <asp:TextBox CssClass="option" ID="TB_Score" runat="server" Text="0" />
        </span>
