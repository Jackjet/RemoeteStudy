...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TS_wp_UserProjectDetailUserControl.ascx.cs" Inherits="Sinp_TeacherWP.WebParts.TS.TS_wp_UserProjectDetail.TS_wp_UserProjectDetailUserControl" %>
                  ...
                  <li class="li_list">
                      <div class="top_remarks">
                          <div class="left_con fl">
                              <span class="times" style="margin-right:70px"><%# Eval("StartDate") %>~<%# Eval("EndDate") %></span><span class="con_details"><em><%# Eval("ProjectLevel") %></em>|<em><%# Eval("ResearchField") %></em>|<em><%# Eval("ProjectDirector") %></em></span></div>
