...
namespace Sinp_TeacherWP.WebParts.TG.TG_wp_ClassExamine
{
    ...
    public class TG_wp_ClassExamine : WebPart
    {
        // 更改可视 Web 部件项目项后，Visual Studio 可能会自动更新此路径。
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/Sinp_TeacherWP.WebParts.TG/TG_wp_ClassExamine/TG_wp_ClassExamineUserControl.ascx";
