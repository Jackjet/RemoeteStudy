...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TG_wp_LearExamineUserControl.ascx.cs" Inherits="Sinp_TeacherWP.WebParts.TG.TG_wp_LearExamine.TG_wp_LearExamineUserControl" %>
...
<script type="text/javascript">
    ...
    //function exitdetail(event, flag, width, height) {
    //    var gid = $(event).parent().parent().find("[id$=DetailID]").val();
    //    window.location.href(siteUrl + '/SitePages/ExamTermPlan.aspx?flag=' + flag + '&itemid=' + gid);
    //    //popWin.showWin("800", "600", "学期计划审核", siteUrl + '/SitePages/ExamTermPlan.aspx?isdlg=1&termplanid=' + gid);
    //    //OpenDialog(siteUrl + '/SitePages/ExamTermPlan.aspx?termplanid=' + gid, width, height, '学期计划审核');
    //}

    //function OpenDialog(pageurl, width, height, title) {
    //    var options = {
            ...
            <div class="tc">
                <div class="No_personnel">
                    ...
                    <div class="menunow">
                        <ul>
                            <li>
                                <a class="menuclick" href="#"><i>+</i>未提交人员（<em><asp:Literal ID="Lit_NoReportCount" runat="server"></asp:Literal></em>）</a>
                                <asp:Repeater ID="Rep_NoReport" runat="server">
                                    <HeaderTemplate>
                                        <ul class="submenu" style="display: none;">
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <li><%#Eval("TeacherName") %></li>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </ul>
                                    </FooterTemplate>
                                ...
                                <ItemTemplate>
                                    <tr class="Single">
                                        ...
                                        <td class="Operations">
                                            ...
                                            <asp:LinkButton ID="LB_Exit" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="Exit" OnClientClick="editpdetail(this,'审核学期计划','/SitePages/ExamTermPlan.aspx?flag=plan&itemid=','800','500');return false;">审核</asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                        ...
                        <asp:ListView ID="LV_FinishExit" runat="server" OnPagePropertiesChanging="LV_FinishExit_PagePropertiesChanging">
                            ...
                            <ItemTemplate>
                                <tr class="Single">
                                    ...
                                    <%--<td class="Operations">
                                        <asp:HiddenField ID="DetailID" runat="server" Value='<%# Eval("ID") %>' />
                                        <asp:LinkButton ID="LB_Exit" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="Exit" OnClientClick="exitdetail(this,'finish','900','600');return false;">查看详情</asp:LinkButton></td>--%>
                                </tr>
                            </ItemTemplate>
                            <AlternatingItemTemplate>
                                <tr class="Double">
