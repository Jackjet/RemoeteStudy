...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="XB_SchoolLibraryTreeUserControl.ascx.cs" Inherits="Sinp_TeacherWP.WebParts.XB.XB_SchoolLibraryTree.XB_SchoolLibraryTreeUserControl" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "get",
            url: FirstUrl + "/_layouts/15/hander/TreeNodes.aspx?timespan=" + timespan,
            data: { ListName: "校本资源库" },
