...
var popWin = {
    ...
    showWin: function (width, height, title, src,scrolling) {
        ...
        inntHtml += '<div id="maskTitle" style="height: 40px; line-height: 40px; font-family: Microsoft Yahei; font-size: 16px; color: #fff; padding-left: 20px; background:#0da6ec; border-shadow: 0 1px 0 #3db8f1; position: relative;">'
        inntHtml += '' + title + ''
